          ...
          <div className="grid">
            ...
            <label className="field">
              ...
              <input
                className="input"
                value={row?.phone ?? ''}
                onChange={(e) => setRow((p) => (p ? { ...p, phone: (e.target as HTMLInputElement).value } : p))}
              />
            </label>
            ...
            <label className="field">
              ...
              <select
                className="select"
                value={row?.stage ?? '신규'}
                onChange={(e) => setRow((p) => (p ? { ...p, stage: (e.target as HTMLSelectElement).value } : p))}
              >
            ...
            <label className="field">
              ...
              <select
                className="select"
                value={row?.grade ?? 'A'}
                onChange={(e) => setRow((p) => (p ? { ...p, grade: (e.target as HTMLSelectElement).value } : p))}
              >
            ...
            <label className="field full">
              ...
              <textarea
                className="textarea"
                value={row?.memo ?? ''}
                onChange={(e) => setRow((p) => (p ? { ...p, memo: (e.target as HTMLTextAreaElement).value } : p))}
              />
            </label>
          </div>
        </section>
